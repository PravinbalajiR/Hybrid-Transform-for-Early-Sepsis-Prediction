# AUTHOR ACTION REQUIRED — PRE-SUBMISSION DISCLOSURE FORM
...
**Target Journal:** *npj Digital Medicine* (Nature Portfolio) / *JAMIA* / *JBI* / *Critical Care* / *IEEE JBHI*

Before uploading the manuscript to the journal submission portal, the human authors must replace the four structured placeholders in Section 6 (`Ethics Statement`, `Funding Statement`, `Conflicts of Interest`, and `Author Contributions`) of `submission_package/final_publication_manuscript.tex` and `submission_package/final_publication_manuscript.md` with the institutional information below:
