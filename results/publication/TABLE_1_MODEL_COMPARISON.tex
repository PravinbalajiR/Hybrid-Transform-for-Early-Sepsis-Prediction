\begin{table}[htbp]
\centering
\caption{Main Performance Comparison Across Models M1–M5 (Per-Model Optimal Thresholds)}
\label{tab:model_comparison}
\begin{tabular}{llllllllllllll}
\hline
\textbf{Model} & \textbf{Architecture} & \textbf{Opt Threshold} & \textbf{AUROC} & \textbf{AUPRC} & \textbf{F1} & \textbf{Precision} & \textbf{Recall} & \textbf{ECE} & \textbf{Mean Lead Time} & \textbf{>=6h} & \textbf{>=1h} & \textbf{FPR/h} & \textbf{Utility} \\
\hline
