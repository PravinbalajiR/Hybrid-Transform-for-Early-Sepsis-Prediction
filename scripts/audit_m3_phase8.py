...
audit_m3_phase8.py
------------------
Standalone Audit Script for Phase 8 M3-UAT: Utility-Aware Temporal Representation Learning.
Verifies all Phase 8 output artifacts, artifact SHA256 hashes, zero test leakage, and scorer equivalence.
"""
...
def main():
    print("=" * 80)
    print("   PHASE 8 — STANDALONE INTEGRITY AUDIT & LEAKAGE VERIFICATION")
    print("=" * 80)
    ...
    required_files = [
        RESULTS_DIR / "m3_phase8_ablation.csv",
        RESULTS_DIR / "m3_phase8_hard_negative_analysis.csv",
        RESULTS_DIR / "m3_phase8_frozen_model.json",
        RESULTS_DIR / "m3_phase8_freeze_manifest.md",
        RESULTS_DIR / "m3_phase8_bootstrap_ci.csv",
        RESULTS_DIR / "m3_phase8_test_report.md",
        RESULTS_DIR / "m3_phase8_utility_decomposition.csv",
        RESULTS_DIR / "m3_phase8_novelty_matrix.csv",
    ]
    ...
    if not all_files_exist:
        print("   CRITICAL ERROR: One or more required Phase 8 output files missing or empty!")
        sys.exit(1)

    # 3. Scorer Equivalence Verification
    decomp_df = pd.read_csv(RESULTS_DIR / "m3_phase8_utility_decomposition.csv")
    ...
    print("\n" + "=" * 80)
    print("   ALL PHASE 8 AUDIT CHECKS PASSED SUCCESSFULLY — SCIENTIFICALLY VALID")
    print("=" * 80)
