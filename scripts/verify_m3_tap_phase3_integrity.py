"""
verify_m3_tap_phase3_integrity.py
---------------------------------
Standalone Verification & Scientific Freeze Audit Script for M3-TAP Phase 3.
Verifies all 7 output artifacts, artifact checksums, zero test leakage, and scorer equivalence.
"""
...
def main():
    print("=" * 80)
    print("   M3-TAP PHASE 3 — STANDALONE INTEGRITY AUDIT & LEAKAGE VERIFICATION")
    print("=" * 80)
    ...
    required_files = [
        RESULTS_DIR / "m3_tap_phase3_policy_sweep.csv",
        RESULTS_DIR / "m3_tap_phase3_pareto_frontier.csv",
        RESULTS_DIR / "m3_tap_phase3_selected_policies.json",
        RESULTS_DIR / "m3_tap_phase3_test_report.md",
        RESULTS_DIR / "m3_tap_phase3_utility_decomposition.csv",
        RESULTS_DIR / "m3_tap_phase3_bootstrap_ci.csv",
    ]
    ...
    decomp_df = pd.read_csv(RESULTS_DIR / "m3_tap_phase3_utility_decomposition.csv")
    ...
    print("\n" + "=" * 80)
    print("   ALL PHASE 3 INTEGRITY AUDIT CHECKS PASSED SUCCESSFULLY — SCIENTIFICALLY VALID")
    print("=" * 80)
