...
audit_m3_phase9.py
------------------
Standalone Audit Script for M3 Phase 9 Utility Boundary & Temporal Policy Generalization (UBPG).
Verifies all 14 Phase 9 output artifacts, artifact SHA256 hashes, zero test leakage, and scorer equivalence.
"""
...
def main():
    print("=" * 80)
    print("   M3 PHASE 9 — STANDALONE INTEGRITY AUDIT & LEAKAGE VERIFICATION")
    print("=" * 80)
    ...
    required_files = [
        RESULTS_DIR / "m3_phase9_threshold_frontier.csv",
        RESULTS_DIR / "m3_phase9_threshold_frontier.png",
        RESULTS_DIR / "m3_phase9_val_test_threshold_comparison.csv",
        RESULTS_DIR / "m3_phase9_policy_sweep.csv",
        RESULTS_DIR / "m3_phase9_pareto_frontier.csv",
        RESULTS_DIR / "m3_phase9_utility_ceiling.csv",
        RESULTS_DIR / "m3_phase9_ablation.csv",
        RESULTS_DIR / "m3_phase9_bootstrap_ci.csv",
        RESULTS_DIR / "m3_phase9_utility_decomposition.csv",
        RESULTS_DIR / "m3_phase9_test_report.md",
        RESULTS_DIR / "m3_phase9_novelty_matrix.csv",
        RESULTS_DIR / "m3_phase9_frozen_policy.json",
        RESULTS_DIR / "m3_phase9_freeze_manifest.md",
    ]
    ...
    if not all_files_exist:
        print("   CRITICAL ERROR: One or more required Phase 9 output files missing or empty!")
        sys.exit(1)

    # 3. Scorer Equivalence Verification
    decomp_df = pd.read_csv(RESULTS_DIR / "m3_phase9_utility_decomposition.csv")
    ...
    print("\n" + "=" * 80)
    print("   ALL PHASE 9 AUDIT CHECKS PASSED SUCCESSFULLY — SCIENTIFICALLY VALID")
    print("=" * 80)
