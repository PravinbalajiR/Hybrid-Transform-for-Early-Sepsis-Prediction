...
audit_m3_phase7.py
------------------
Standalone Audit Script for M3 Phase 7 Utility-Aware Temporal Representation Learning (U-TRL).
Verifies all Phase 7 output artifacts, artifact SHA256 hashes, zero test leakage, and scorer equivalence.
"""
...
def main():
    print("=" * 80)
    print("   M3 PHASE 7 — STANDALONE INTEGRITY AUDIT & LEAKAGE VERIFICATION")
    print("=" * 80)
    ...
    required_files = [
        RESULTS_DIR / "m3_phase7_trajectory_groups.csv",
        RESULTS_DIR / "m3_phase7_score_separation.csv",
        RESULTS_DIR / "m3_phase7_publication_table.csv",
        RESULTS_DIR / "m3_phase7_novelty_matrix.csv",
        RESULTS_DIR / "m3_phase7_frozen_model.json",
        RESULTS_DIR / "m3_phase7_ablation.csv",
        RESULTS_DIR / "m3_phase7_utility_decomposition.csv",
        RESULTS_DIR / "m3_phase7_test_report.md",
    ]
    ...
    if not all_files_exist:
        print("   CRITICAL ERROR: One or more required Phase 7 output files missing or empty!")
        sys.exit(1)

    # 3. Scorer Equivalence Verification
    decomp_df = pd.read_csv(RESULTS_DIR / "m3_phase7_utility_decomposition.csv")
    ...
    print("\n" + "=" * 80)
    print("   ALL PHASE 7 AUDIT CHECKS PASSED SUCCESSFULLY — SCIENTIFICALLY VALID")
    print("=" * 80)
