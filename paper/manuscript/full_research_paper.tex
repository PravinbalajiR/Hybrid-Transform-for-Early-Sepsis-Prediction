...
Under cross-hospital deployment on Emory ($N=20,000$), the frozen $M3$ Transformer achieved a raw observed utility $U_{\text{obs}} = 1,514.78$ points, an inaction reference utility $U_{\text{inact}} = -9,512.4444$ points, an oracle best utility $U_{\text{best}} = 7,298.7778$ points, and an official normalized utility of:
\begin{equation}
